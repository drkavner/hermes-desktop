export default {
  title: "Welcome to Cerebratech AI",
  subtitle:
  ...
  dividerOr: "or",
  connectRemote: "Connect to Remote Cerebratech AI",
  connectRemoteTitle: "Connect to Remote Cerebratech AI",
  connectRemoteSubtitle: "Enter the URL of a running Cerebratech AI API server.",
