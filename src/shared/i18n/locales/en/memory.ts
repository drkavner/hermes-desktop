export default {
  title: "Memory",
  subtitle:
    "What Cerebratech AI remembers about you and your environment across sessions.",
  sessions: "Sessions",
  messages: "Messages",
  memories: "Memories",
  ...
  noMemoriesYet: "No memories yet. Cerebratech AI will save important facts as you chat.",
  ...
  userProfileHint: "Tell Cerebratech AI about yourself — name, role, preferences, communication style.",
  providersHint: "Pluggable memory providers give Cerebratech AI advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
