export default {
  ...
  dividerOr: "或",
  connectRemote: "连接远程 Cerebratech AI",
  connectRemoteTitle: "连接远程 Cerebratech AI",
  connectRemoteSubtitle: "输入运行中的 Cerebratech AI API 服务器的 URL。",
